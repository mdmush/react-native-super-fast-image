...
public class SuperFastImageSource extends ImageSource {
    ...
    public SuperFastImageSource(Context context, String source) {
        this(context, source, null);
    }

    public SuperFastImageSource(Context context, String source, @Nullable Headers headers) {
        this(context, source, 0.0d, 0.0d, headers);
    }

    public SuperFastImageSource(Context context, String source, double width, double height, @Nullable Headers headers) {
    ...
    public boolean isBase64Resource() {
        return mUri != null && SuperFastImageSource.isBase64Uri(mUri);
    }

    public boolean isResource() {
        return mUri != null && SuperFastImageSource.isResourceUri(mUri);
    }

    public boolean isLocalFile() {
        return mUri != null && SuperFastImageSource.isLocalFileUri(mUri);
    }

    public boolean isContentUri() {
        return mUri != null && SuperFastImageSource.isContentUri(mUri);
    }
