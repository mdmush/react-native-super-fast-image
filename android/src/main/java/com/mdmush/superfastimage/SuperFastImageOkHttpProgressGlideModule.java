...
@GlideModule
public class SuperFastImageOkHttpProgressGlideModule extends LibraryGlideModule {
    ...
    static void expect(String key, SuperFastImageProgressListener listener) {
    ...
    private static class DispatchingProgressListener implements ResponseProgressListener {
        private final Map<String, SuperFastImageProgressListener> LISTENERS = new WeakHashMap<>();
        ...
        void expect(String key, SuperFastImageProgressListener listener) {
            LISTENERS.put(key, listener);
        }

        @Override
        public void update(final String key, final long bytesRead, final long contentLength) {
            final SuperFastImageProgressListener listener = LISTENERS.get(key);
            if (listener == null) {
                return;
            }
