...
public class SuperFastImageRequestListener implements RequestListener<Drawable> {
    ...
    SuperFastImageRequestListener(String key) {
        this.key = key;
    }
    ...
    public boolean onLoadFailed(@android.support.annotation.Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
        ...
        SuperFastImageViewWithUrl view = (FastImageViewWithUrl) ((ImageViewTarget) target).getView();
