...
class SuperFastImageViewConverter {
    private static final Drawable TRANSPARENT_DRAWABLE = new ColorDrawable(Color.TRANSPARENT);

    private static final Map<String, SuperFastImageCacheControl> FAST_IMAGE_CACHE_CONTROL_MAP =
            new HashMap<String, SuperFastImageCacheControl>() {{
                put("immutable", SuperFastImageCacheControl.IMMUTABLE);
                put("web", SuperFastImageCacheControl.WEB);
                put("cacheOnly", SuperFastImageCacheControl.CACHE_ONLY);
            }};
    ...
    static SuperFastImageSource getImageSource(Context context, ReadableMap source) {
        return new SuperFastImageSource(context, source.getString("uri"), getHeaders(source));
    }
    ...
    static RequestOptions getOptions(Context context, SuperFastImageSource imageSource, ReadableMap source) {
        // Get priority.
        final Priority priority = SuperFastImageViewConverter.getPriority(source);
        // Get cache control method.
        final SuperFastImageCacheControl cacheControl = SuperFastImageViewConverter.getCacheControl(source);
        ...
        if (imageSource.isResource()) {
            ...
            // solves this issue: https://github.com/mdmush/react-native-super-fast-image/issues/402
    ...
    private static SuperFastImageCacheControl getCacheControl(ReadableMap source) {
